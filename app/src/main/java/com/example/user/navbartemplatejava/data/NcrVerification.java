...
public class NcrVerification implements Serializable {
    ...
    @SerializedName("disposition_inspector")
    @Expose
    private DispositionInspector dispositionInspector;
    ...
    public DispositionInspector getDispositionInspector() {
        return dispositionInspector;
    }
